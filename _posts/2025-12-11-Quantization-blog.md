...
- [Official PyTorch Quantization Documentation](https://pytorch.org/docs/stable/quantization.html)  
- Lei Mao’s blog post on the subject, as referenced in the Hugging Face docs
